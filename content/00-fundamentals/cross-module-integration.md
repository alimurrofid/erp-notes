...
flowchart TD
    ...
    -->|Reserve Stock| B["2. Inventory Module\nStaf gudang kirim barang\nDelivery / Goods Issue"]
    B -->|Automatic Perpetual Entry| C["3. Accounting (General Ledger)\nPersediaan berkurang\nBeban HPP diakui"]
    A -->|Trigger Billing| D["4. Accounting (AR Module)\nFaktur diterbitkan\nCustomer Invoice Posted"]
    D -->|Posting Revenue & VAT| C
    D -->|Wait for Payment| E["5. Finance Module\nCustomer transfer ke Bank\nBank Receipt Posted"]
...
```mermaid
flowchart TD
    P1["1. Purchasing Module\nPO diterbitkan ke Vendor\nPurchase Order Approved"]
    -->|Pending Receipt| P2["2. Inventory Module\nBarang tiba di gudang\nGoods Receipt Posted"]
    P2 -->|Inventory Valuation & Accrual| P3["3. Accounting (General Ledger)\nPersediaan bertambah\nAkun Penampung GR/IR dikredit"]
    P1 -->|Order Reference| P4["4. Accounting (AP Module)\nVendor kirim tagihan\nVendor Bill Matched"]
    P2 -->|Quantity Check| P4
    P4 -->|Clear GR/IR & Post AP| P3
    P4 -->|Payment Due| P5["5. Finance Module\nTransfer pembayaran ke Vendor\nBank Disbursement Posted"]
