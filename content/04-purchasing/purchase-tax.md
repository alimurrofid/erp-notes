...
```mermaid
flowchart TD
    Supp["1. Supplier Tax Profile\n(PKP / Non-PKP, Wajib Pungut, Asing / Domestik)"]
    --> Engine{"ERP Tax Determination Engine"}

    Item["2. Item Tax Classification\n(Barang Kena Pajak, Jasa Objek PPh 23, Barang Bebas PPN)"]
    --> Engine

    Use["3. Business Purpose / Intended Use\n(Operasional Produktif vs Konsumsi Pribadi Direksi)"]
    --> Engine
