...
```mermaid
flowchart TD
    PO["1. Purchase Order Disahkan\n(Termin: Uang Muka 20% Dimuka)"]
    --> Req["2. Prepayment Request / Advance Invoice\n(Permohonan pembayaran uang muka dari vendor)"]
    --> Pay["3. Transfer Kas Bank\n(Dr. Uang Muka Pemasok / Cr. Bank)\n=> Tercatat sebagai Aset di Neraca"]
    
    PO --> Del["4. Pengiriman & Penerimaan Barang (GR)\n(Barang fisik tiba lengkap di gudang)"]
    Del --> Bill["5. Faktur Tagihan Final Tiba (Vendor Bill)\n(Dr. Persediaan & PPN / Cr. Utang Usaha 100%)"]
    
    Pay -.-> Settle{"6. Prepayment Application / Settlement"}
    Bill -.-> Settle
    
    Settle --> Clear["7. Pemotongan Uang Muka:\n(Dr. Utang Usaha / Cr. Uang Muka Pemasok)\n=> Sisa Utang 80% Dilunasi via Bank"]
```
