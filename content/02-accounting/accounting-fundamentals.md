...
flowchart TD
    subgraph BalanceSheetElements["Posisi Keuangan (Neraca / Balance Sheet)"]
        Asset["1. Aset (Assets)\nSumber daya ekonomi yang dikendalikan entitas\nakibat peristiwa masa lalu yang memiliki potensi manfaat ekonomi."]
        Liab["2. Liabilitas (Liabilities)\nKewajiban kini entitas untuk mengalihkan sumber daya ekonomi\nakibat peristiwa masa lalu."]
        Eq["3. Ekuitas (Equity)\nHak residual atas aset entitas\nsetelah dikurangi seluruh liabilitasnya."]
    end

    subgraph PL_Elements["Kinerja Finansial (Laba Rugi / Income Statement)"]
        Rev["4. Pendapatan (Revenue / Income)\nPeningkatan aset atau penurunan liabilitas yang menghasilkan\npeningkatan ekuitas, selain dari kontribusi pemilik."]
        Exp["5. Beban (Expenses)\nPenurunan aset atau peningkatan liabilitas yang menghasilkan\npenurunan ekuitas, selain dari distribusi kepada pemilik."]
    end
...
```mermaid
flowchart LR
    Doc["1. Operational Document\n(Delivery, Receipt, Invoice)"]
    --> Rule["2. Posting Engine / Rules\n(Account Determination)"]
    --> JE["3. Journal Entry\n(Debit = Credit Balancing)"]
    --> GL["4. General Ledger & Subledgers\n(Updated Real-time)"]
    --> TB["5. Trial Balance\n(Neraca Saldo)"]
