...
flowchart TD
    PO["1. Purchase Order\n(Komitmen Pengadaan)"]
    --> GR["2. Penerimaan Barang (GR)\n(Pengakuan Akrual Persediaan / GR/IR)"]
    --> Match{"3. 3-Way Matching\n(PO vs GR vs Vendor Bill)"}
    Match -->|Valid| Inv["4. Pengakuan Utang Resmi (AP)\n(Tutup Akun Kliring GR/IR)"]
    Match -->|Discrepancy| Hold["Payment Blocked / Price Variance"]
    Hold -->|Resolved| Inv
    Inv --> Pay["5. Pembayaran Kas-Bank\n(Dr. AP / Cr. Bank)"]
    Inv --> Ret["6. Retur Pembelian\n(Dr. AP via Debit Note)"]
```
