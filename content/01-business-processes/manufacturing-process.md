...
```mermaid
flowchart TD
    DMD["1. Demand & Planning\n(Sales Demand / Safety Stock / MRP)"]
    --> MO["2. Work Order Creation\n(BOM & Routing Explosion)"]
    --> REL["3. Component Reservation & Release\n(Pemeriksaan Ketersediaan Bahan)"]
    --> ISS["4. Material Issue / Consumption\n(Bahan Baku Keluar -> Masuk WIP)"]
    --> OPS["5. Shop Floor Operations\n(Eksekusi Mesin & Jam Tenaga Kerja)"]
    --> REC["6. Finished Goods Receipt\n(Barang Jadi Masuk Gudang -> Tutup WIP)"]
    --> SET["7. Costing & Variance Settlement\n(Penyelesaian Varians Biaya)"]
```
