...
flowchart TD
    ...
    EMP --> PERS1["1. Perspektif Penggajian (Payroll Perspective)\n'Berapa yang dibayarkan ke/atas nama pegawai?'"]
    ...
    EMP --> PERS2["2. Perspektif Akuntansi Biaya (Cost Accounting Perspective)\n'Ke mana nilai kerja tersebut diserap?'"]
